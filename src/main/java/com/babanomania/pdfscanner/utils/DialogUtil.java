...
public class DialogUtil {
    ...
    public static void askUserFilaname( Context context, String promptFileName, String promptCategory, final com.pandasdroid.scanner.utils.DialogUtilCallback callback ){
